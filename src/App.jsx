...
function App() {
  ...
  return (
    <Router>
      ...
      <FloatingWhatsApp currentLanguage={currentLanguage} />
            ...
            <div className="contact-info">
              <div className="info-item">
                ...
                <p dangerouslySetInnerHTML={{ __html:
                  currentLanguage === 'en'
                    ...
                    : "المقر الرئيسي : مكة المكرمة - حي الرصيفة - شارع عبدالله عريف - بجوار محطة قطار الحرمين - بجوار مجمع الاتصالات<br />فرع الأحساء : الهفوف - حي الروضة - شارع الخليج - مبنى التميمي - الدور الثالث<br />فرع مصر : القاهرة - حي المعادي - تقاطع 75 مع شارع 12"
                }} />
              </div>
              <div className="info-item">
                ...
                <p>
                  {currentLanguage === 'en' ? (
                    ...
                    <>
                      المقر الرئيسي : <a href="tel:00966545181910" className='phone-number ltr-text'>00966545181910</a><br />
                      فرع الأحساء : <a href="tel:00966566497730" className='phone-number ltr-text'>00966566497730</a><br />
                      فرع مصر : <a href="tel:00201116999260" className='phone-number ltr-text'>00201116999260</a>
                    </>
                  )}
                </p>
              </div>
              <div className="info-item">
                <h4 data-en="Email" data-ar="البريد الإلكتروني">
                  {'✉️ ' + (currentLanguage === 'en' ? 'Email' : 'البريد الإلكتروني')}
                </h4>
