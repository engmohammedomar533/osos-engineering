...
const departments = [
  ...
  },
  {
    ...
    accent: '#c0392b',
    members: [
      { nameEn: 'Abdulaziz Salim',  nameAr: 'عبدالعزيز سليم', titleEn: 'Administrative Manager', titleAr: 'مدير إداري',    isHead: true },
      { nameEn: 'Ahmed El-Azazy',   nameAr: 'احمد العزازي',   titleEn: 'Technical Manager',      titleAr: 'مدير فني' },
      { nameEn: 'Mostafa Ezz',      nameAr: 'مصطفى عز',       titleEn: 'Architect',               titleAr: 'مهندس معماري' },
      { nameEn: 'Mostafa Soliman',  nameAr: 'مصطفى سليمان',   titleEn: 'Architect',               titleAr: 'مهندس معماري' },
      { nameEn: 'Mohamed Gamal',    nameAr: 'محمد جمال',       titleEn: 'Architect',               titleAr: 'مهندس معماري' },
      { nameEn: 'Karim Ettihamy',   nameAr: 'كريم التهامي',   titleEn: 'Architect',               titleAr: 'مهندس معماري' },
      { nameEn: 'Sohaila Yasser',   nameAr: 'سهيلة ياسر',     titleEn: 'Interior Designer',       titleAr: 'مصممة ديكور' },
      { nameEn: 'Israa Hassan',     nameAr: 'اسراء حسن',       titleEn: 'Interior Designer',       titleAr: 'مصممة ديكور' },
      { nameEn: 'Doaa',             nameAr: 'دعاء',             titleEn: 'Interior Designer',       titleAr: 'مصممة ديكور' },
      { nameEn: 'Youssef Abdelaziz', nameAr: 'يوسف عبدالعزيز', titleEn: 'Engineer',               titleAr: 'مهندس' },
      { nameEn: 'Shaimaa Majed',    nameAr: 'شيماء ماجد',      titleEn: 'Engineer',               titleAr: 'مهندسة' },
      { nameEn: 'Israa El-Sawaf',   nameAr: 'اسراء الصواف',    titleEn: 'Engineer',               titleAr: 'مهندسة' },
      { nameEn: 'Tarek Hamdy',      nameAr: 'طارق حمدي',       titleEn: 'Engineer',               titleAr: 'مهندس' },
      { nameEn: 'Ziad Hossam',      nameAr: 'زياد حسام',       titleEn: 'Engineer',               titleAr: 'مهندس' },
      { nameEn: 'Rahma',            nameAr: 'رحمة',             titleEn: 'Mechanical Engineer',    titleAr: 'مهندسة ميكانيكا' },
      { nameEn: 'Hazem',            nameAr: 'حازم',             titleEn: 'Mechanical Engineer',    titleAr: 'مهندس ميكانيكا' },
    ],
  },
];
